...
<div class="container main-content">
		...
		<div class="navbar navbar-inverse">
			...
			<div class="collapse navbar-collapse navbar-right" id="subnavbar">
				<ul class="nav navbar-nav">
					<li class="active"><a href="#">黑臭水治理</a></li>
					<li><a href="#">海绵城市</a></li>
					<li><a href="#">农村污水治理</a></li>
					<li><a href="#">人工湿地</a></li>
				</ul>
			</div>
		</div>
	...
	<div class="well well-sm">
		...
		<div class="media">
			<a class="media-img pull-right" href="#"> <img
				class="media-object" src="${HY_CONTEXT}/resources/images/solution2.jpg" alt="媒体对象">
			</a>
			<div class="media-body">
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
					Aenean euismod bibendum laoreet Proin gravida dolor sit amet lacus
