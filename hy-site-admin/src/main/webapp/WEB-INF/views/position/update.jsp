...
<form class="form-horizontal bind-update-from" role="form" action="${HY_CONTEXT}/position/update" method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<textarea rows="8" name="duty" id="duty" class="form-control">${position.duty }
			</textarea>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<textarea rows="8" name="recruitment" id="recruitment" class="form-control">${position.recruitment }
			</textarea>
		</div>
	</div>
...
<script src="${HY_CONTEXT}/resources/js/views/position/update.js"></script>
